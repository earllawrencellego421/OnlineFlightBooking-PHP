 ...
 * ============================================================
 *  ADMIN LOGIN HANDLER
 *  Location: includes/admin/login.inc.php
 *  Do NOT confuse with includes/login.inc.php (passenger login).
 *  This file authenticates against the `admin` table, not `Users`.
 * ============================================================
 */
