 ...
 *  Do NOT confuse with includes/admin/login.inc.php (admin login).
 *  This file authenticates against the `Users` table, not `admin`.
 * ============================================================
 */
    ...
    if(!mysqli_stmt_prepare($stmt,$sql)) {
        ...
        if($row = mysqli_fetch_assoc($result)) {
            ...
            if($pwd_check == false) {
                ...
                // Removed: setcookie('Uname'/'Upwd', ...) — this was storing
                // the raw plaintext password in a browser cookie for 30 days.
